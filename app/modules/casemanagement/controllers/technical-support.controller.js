(function() {
    'use strict';
    angular.module('pb.casemanagement').controller('TechnicalSupportCtrl',
        ['$log', '$scope', '$controller','MockDataFactory', '$state', '$stateParams','$window',
            function($log, $scope, $controller,MockDataFactory, $state, $stateParams,$window) {
                var _this = this;
                var slides;
                  ...
                  $scope.toggleDropdown = function($event) {
                    ...
                    $scope.init = function appendText() {
                        var myEl = angular.element(document.querySelector('.tags ul.filter-tabs li.tag--main.secondary'));
                            ...
                            myEl.append('<a class="appended-breadcrumb" ui-sref="casemanagement.technicalsupport">Technical Support</a>');
                                }

                    function globalcontactus(){
                        $window.location.href = 'http://www.pitneybowes.com/us/contact-global.html';
                    }
